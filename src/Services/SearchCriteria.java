...
// Constructors
	...
	public SearchCriteria(String houseType, int numBedrooms, int numBathrooms, int ifFurnished, String quadrant,
			int budget) {
		super();
	...
	public boolean editSearchCriteria(String houseType, int numBedrooms, int numBathrooms, int ifFurnished,
			String quadrant) {
...
// Setters and Getters			 
	...
	public void setIfFurnished(int ifFurnished) {
		this.ifFurnished = ifFurnished;
	}
